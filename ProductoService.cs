...
namespace Administracion
{
    class ProductoService
    {
        ...
        public static Producto ModificarProducto(List<Producto> ListaProductos, Producto findModificar, int opcionCambiar, string nuevoValor) // Not yet done
        {
        ...
        public static Producto BuscarProducto(List<Producto> ListaProductos, bool Especifico = false, bool newLine = false)
        {
            if (ListaProductos.Count != 0)
            {
                ...
                else
                {
                    ...
                    if (resultados.Count > 0)
                    {
                        ...
                        ProductoService.ImprimirProductos(resultados);

                        if (Especifico)
                        {
                            Console.WriteLine(System.Environment.NewLine + "Ingresa el ID del producto para anadir stock: ");

                            idSearch = ProductoService.ValidarEntero(1, 999999999, "Debe ser un entero mayor o igual a 1", "");
